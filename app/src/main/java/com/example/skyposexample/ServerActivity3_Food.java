...
public class ServerActivity3_Food extends Activity {
...
//        db.execSQL(sql);
        ...
        Cursor c = db.rawQuery("select * from goods where goodsCatNum = 1;", null);
        while(c.moveToNext()){
        ...
        lv3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ServerActivity3_Food.this, ServerActivity3TabMenu.class);
